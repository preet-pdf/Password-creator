...
class GUI():
    ...
    def __init__(self,master):
        ...
        self.label=Label(text="Password Generator",fg='White',font='Helvetica 35 bold')
        ...
        self.generated_password_textfield=Entry(font='times 20',bd=6,relief='groove',fg='lightgreen')
        ...
        self.generate=Button(text="Generate Password",bd=4,relief='solid',padx=1,pady=1,font='forte 25 bold',fg='lightblue',bg='black',command=self.generate_pass)
        self.generate.grid(row=12,column=0)


        self.reset=Button(text="Reset",bd=4,relief='solid',padx=1,pady=1,font='forte 25 bold',fg='lightblue',bg='black',command=self.reset_fields)
